...
[![Live Demo](https://img.shields.io/badge/LIVE_DEMO-episteme.vercel.app-FFB000?style=for-the-badge&labelColor=191209&color=FFB000)](https://episteme.vercel.app)
...
USER      → "It found patterns that were specific to the training
...
EPISTEME  → "You just described the bias-variance tradeoff without
              ...
              [ DEPTH UPGRADE: SURFACE → ANALYTICAL ]
              [ CLARITY: 31 → 58 ]
```
